...
Version  : 1.6.15
Release  : 20
URL      : https://mirrors.kernel.org/gnu/freeipmi/freeipmi-1.6.15.tar.gz
Source0  : https://mirrors.kernel.org/gnu/freeipmi/freeipmi-1.6.15.tar.gz
Source1  : https://mirrors.kernel.org/gnu/freeipmi/freeipmi-1.6.15.tar.gz.sig
...
%setup -q -n freeipmi-1.6.15
cd %{_builddir}/freeipmi-1.6.15
pushd ..
cp -a freeipmi-1.6.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736975422
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfreeipmi.so.17.2.13
/V3/usr/lib64/libipmiconsole.so.2.3.7
/V3/usr/lib64/libipmidetect.so.0.0.1
/V3/usr/lib64/libipmimonitoring.so.6.0.9
/usr/lib64/libfreeipmi.so.17
/usr/lib64/libfreeipmi.so.17.2.13
/usr/lib64/libipmiconsole.so.2
/usr/lib64/libipmiconsole.so.2.3.7
