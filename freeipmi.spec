...
Source0  : https://mirrors.kernel.org/gnu/freeipmi/freeipmi-1.6.11.tar.gz
Source1  : https://mirrors.kernel.org/gnu/freeipmi/freeipmi-1.6.11.tar.gz.sig
Summary  : FreeIPMI
...
%prep
%setup -q -n freeipmi-1.6.11
cd %{_builddir}/freeipmi-1.6.11
pushd ..
cp -a freeipmi-1.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686233400
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfreeipmi.so.17.2.10
...
/usr/lib64/libfreeipmi.so.17.2.10
